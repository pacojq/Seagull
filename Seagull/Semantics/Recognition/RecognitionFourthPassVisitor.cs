...
namespace Seagull.Semantics.Recognition
{
	...
	/// </summary>
    public class RecognitionFourthPassVisitor : AbstractRecognitionVisitor<Void>
	{
		...
		public override Void Visit(Variable var, INamespaceDefinition p)
		{
		...
		public override Void Visit(FunctionInvocation func, INamespaceDefinition p)
		{
			//base.Visit(func, p);
