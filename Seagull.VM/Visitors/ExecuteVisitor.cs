...
{
	public delegate void SeagullVMAction();
	
	
	public class ExecuteVisitor : AbstractVisitor<SeagullVMAction, Void>
	{

		private readonly Memory _memory;
		
		public ExecuteVisitor(Memory memory)
		{
			_memory = memory;
		}
		...
		public override SeagullVMAction Visit(Program program, Void p)
		{
			SeagullVMAction result = () => { };
			...
			foreach (IDefinition def in program.Definitions)
			{
				...
				{
					SeagullVMAction action = def.Accept(this, p);
					if (action != null)
						result += action;
				}
			}
		...
		public override SeagullVMAction Visit(FunctionDefinition functionDefinition, Void p)
		{
